...
const APP_SHELL = [
  "./", "./index.html", "./styles.css?v=12", "./app.js", "./addons.js?v=6", "./manifest.webmanifest", OFFLINE_URL,
  "./assets/icons/icon.svg", "./assets/icons/icon-192.png", "./assets/icons/icon-512.png",
  "./assets/vendor/leaflet/leaflet.css", "./assets/vendor/leaflet/leaflet.js"
];

const LOCAL_DATA = ["./data/countries.json", "./data/states.json", "./data/world.geojson", "./data/glossary.json", "./data/knowledge.json", "./data/astronomy-events-2026.json", "./data/hydrography.json", "./data/relief.json"];
